...
- (void)loginWith:(NSString *)mobile
    ...
    completeBlock:(void (^)(HXSErrorCode, NSString *, NSNumber *, HXSUserBasicInfo *))block
{
    ...
    [dic setObjectExceptNil:mobile forKey:@"mobile"];
    [dic setObjectExceptNil:password forKey:@"password"];
                   ...
                   progress:nil
                    success:^(HXSErrorCode status, NSString *msg, NSDictionary *data) {
                        if(status == kHXSNoError) {
                            ...
                            HXSUserBasicInfo * info = [[HXSUserBasicInfo alloc] initWithDictionary:data error:&error];
                ...
                completeBlock:(void (^)(HXSErrorCode, NSString *, NSNumber *, HXSUserBasicInfo *))block
{
    ...
    else if (accountType == kHXSWeixinAccount)
    {
        ...
        [dic setObjectExceptNil:accountToken forKey:@"access_token"];
    }else if (accountType == kHXSAlipayAccount)
    {

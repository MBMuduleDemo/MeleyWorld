...
- (void)configureProperty
{
    ...
    _textFieldBorderColor = ML_BORDER_COLOR;
    _textFieldBackgroudColor = UIColorFromRGB(0xf7f7f7);
...
- (UIColor *)buttonTextColorWithStyle:(TYAlertActionStyle)style
{
    switch (style) {
        case TYAlertActionStyleDefault:
            return _buttonDefaultTextColor;
        case TYAlertActionStyleCancel:
            return _buttonCancelTextColor;
        case TYAlertActionStyleDestructive:
...
- (void)addTextLabels
{
    ...
    messageLabel.textColor = UIColorFromRGB(0x6e6e6e);
...
- (void)layoutContentViews
{
    ...
    _buttonTopConstraint = [self addConstarintWithTopView:_textFieldContentView toBottomView:_buttonContentView constarint:40];
    
    [self addConstarintWithView:_buttonContentView topView:nil leftView:self bottomView:self rightView:self edageInset:UIEdgeInsetsMake(0, _buttonContentViewEdge, 0, -_buttonContentViewEdge)];
}
...
- (void)layouttextFields
{
    ...
    if (_textFields.count == 1) {
        ...
        _textFieldContentView.layer.cornerRadius = 0;

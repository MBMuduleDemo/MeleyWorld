...
- (void)setPageSpacingBetweenDots:(CGFloat)pageSpacingBetweenDots{
    _pageSpacingBetweenDots = pageSpacingBetweenDots;
    if ([self.pageControl isKindOfClass:[TAPageControl class]]) {
        TAPageControl *pageControl = (TAPageControl *)_pageControl;
        pageControl.spacingBetweenDots = pageSpacingBetweenDots;
    }
}
